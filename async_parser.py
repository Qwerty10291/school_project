            ...
            async with session.get(url, allow_redirects=True, params=params) as query:
                if query.status != 200:
                    ...
                    if query.status == 503:
                        ...
                        await asyncio.sleep(retries + random.randint(1, 3))
...
@singleton
class AsyncParserController(object):
    ...
    def create_parser(self, user_id, parameters):
        ...
        return history_id, history_status
    ...
    def _add_parameters(self, params: dict):
        params['pageNumber'] = '1'
        params['morphology'] = 'on'
        params['recordsPerPage'] = '_50'
        params['fz44'] = 'on'
        params['pc'] = 'on'
        return params
